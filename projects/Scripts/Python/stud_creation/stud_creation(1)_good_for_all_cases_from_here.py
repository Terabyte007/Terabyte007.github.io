...
# print(f"Total rows skipped: {len(skipped_rows)}")
print(f"Unique students processed: {len(unique_matric_set)}")
print(f"New student records added to `tbl_students_master_test`: {len(unique_matric_set)}")
# print(f"Student records skipped due to unmatched faculty/department: {skipped_student_master_rows}")
# if unmatched_faculties:
#     print(f"⚠️ Unmatched Faculties: {len(unmatched_faculties)}")

# if unmatched_departments:
#     print(f"⚠️ Unmatched Departments: {len(unmatched_departments)}")
# print(f"Skipped student details exported to: {skipped_output_file}")
# print(f"Skipped student details exported to: 'skipped_students sheet'")
print(f"\nInserted {transaction_rows_inserted} rows into tbl_students_transactions_test.")
# print(f"Skipped {len(skipped_transaction_records)} transaction records. See 'skipped_transactions sheet' for details.")
...
print(f"Students with issues will be logged in the import_logs file")
print(f"\nInserted {inserted_rows} rows into tbl_course_registered_test.")
# print(f"Skipped {len(skipped_rows)} rows. See 'skipped_courses sheet' for details.")
