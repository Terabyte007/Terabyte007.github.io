...
# === 5. LOAD FACULTY, DEPARTMENT, AND COURSE MAPPINGS ===
print("=== LOADING FACULTY, DEPARTMENT, AND COURSE MAPPINGS ===")
...
for _, row in tqdm(df.iterrows(), total=len(df), desc="  Populating students_courses & tbl_students_master_test:"):
    ...
    if not master_row:
        ...
        student_data = (
            ...
            result_session_id, faculty_id, departments_id, 44,
            mode_id, '', '', '', '', '', ''
        )
...
for matric_no, utme_no in tqdm(students_master_data, desc="  Creating student user accounts:"):
