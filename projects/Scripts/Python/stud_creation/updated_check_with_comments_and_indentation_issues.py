...
data_tuple = (
        ...
        row.get("student_department", remark), faculty_raw, row.get("course_title"),
...
for matric_no, surname in tqdm(students_master_data, desc="Progress level:"):
