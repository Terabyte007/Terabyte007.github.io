...
for record in course_records:
    ...
    if dept_info:
        ...
        cursor.execute("SELECT dept_id_fk FROM tbl_courses WHERE code = %s", (course_code,))
        ...
        if dept_result:
            ...
            skipped_rows.append({'matric_no': matric_no, 'reason': f'Course department not resolved for code {course_code}'})
            continue
